<div id="editQuestionFormModal" class="fixed z-20 inset-0 overflow-y-auto hidden">
    <div class="flex items-center justify-center min-h-screen text-gray-950">
        <div class="bg-white w-1/2 p-6 rounded-xl shadow-lg">
            <div class="flex justify-between">
                ...
                <button id="closeEditQuestionForm" class="text-gray-500 hover:text-red-500">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                    </svg>
                </button>
            </div>
            <p class="font-light text-[14px] py-5 text-left">Giáo viên có thể đổi thông tin câu hỏi ở đây</p>
            
            <form  id="questionForm" method="POST">
                @csrf
                @method('PUT')
                <label for="">Câu hỏi: </label>
                <textarea name="content" cols="10" rows="3" class="w-full border-gray-300 rounded-md font-light focus:border-blue-50 mb-3 mt-2" id="questionContent"></textarea>
               ...
               <div class="mt-5">
                   ...
                   <select name="topic_id" id="questionTopic" class="w-full border-gray-300 rounded-md font-light focus:border-blue-50 mb-3">
