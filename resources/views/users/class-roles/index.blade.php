    ...
    <div class="mt-20 mx-8 mr-80">
        <div class="mt-5 mb-7 grid grid-cols-11 gap-3 items-center ">
            <div class="col-span-8 flex relative justify-between items-center">
                <input type="text" class="border border-gray-300 rounded-md focus:border-blue-50 focus:outline-none w-full cursor-pointer" placeholder="Tìm tên giáo viên...">
            ...
            <div class="col-span-2 gap-2 bg-blue-500 hover:bg-blue-600 py-2 px-3 rounded-lg text-white font-medium justify-center text-center">
                <button id="openContactForm">Thêm giáo viên</button>
            ...
            <table class="w-full text-sm text-left border-x">
                ...
                <tbody>
                    <tr class="odd:bg-white even:bg-gray-50 border-b hover:bg-blue-100">
                        ...
                        <td class="px-6 py-4">Chủ sở hữu lớp học</td>
...
<script>
    ...
    const $openContactFormButton = $('#openContactForm');
    const $closeContactFormButton = $('#closeContactForm');
    const $contactFormModal = $('#contactFormModal');
    const $overlay = $('#overlay');

    $openContactFormButton.on('click', function() {
        $contactFormModal.removeClass('hidden');
        $overlay.removeClass('hidden');
    });

    $closeContactFormButton.on('click', function() {
        $contactFormModal.addClass('hidden');
