       ...
       @include('users.topics.index')
        <div class="col-span-4">
            ...
            <div class="hover:bg-gray-100 py-3 px-5">
                <h1 class="text-gray-950 font-medium">Tiêu đề bài tập</h1>
                        ...
                        <div class="relative">
                            ...
                            <div id="" class="menu-file hidden absolute right-0 w-48 bg-white rounded-lg shadow-2xl z-10">
                                ...
                                <div class="flex flex-1 items-center gap-2 px-4 py-2 hover:bg-gray-100">
                                    ...
                                    <a href="#" class="block text-md">Chỉnh sửa bài tập</a>
                                </div>
                                <div class="flex flex-1 items-center gap-2 px-4 py-2 hover:bg-gray-100">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="m20.25 7.5-.625 10.632a2.25 2.25 0 0 1-2.247 2.118H6.622a2.25 2.25 0 0 1-2.247-2.118L3.75 7.5m6 4.125 2.25 2.25m0 0 2.25 2.25M12 13.875l2.25-2.25M12 13.875l-2.25 2.25M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125Z" />
                                    </svg>                                                                                          
                                    <a href="#" class="block text-md">Xóa bài tập</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        $('#openHomeworkForm').on('click', function() {
            $('#fileHomeworkModal').removeClass('hidden');
            $('#overlay').removeClass('hidden');
        });

        $('#closeHomewworkForm').on('click', function() {
            $('#fileHomeworkModal').addClass('hidden');
