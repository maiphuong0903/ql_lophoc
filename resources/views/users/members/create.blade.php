    ...
    <div class="flex items-center justify-center min-h-screen text-gray-950">
        <div class="bg-white w-1/3 p-6 rounded-xl shadow-lg">
            ...
            <form action="" method="post">
                <input type="text" class="w-full border-gray-300 rounded-md font-light focus:border-blue-50" placeholder="Nhập email đăng nhập của học sinh...">
                <button type="submit" class="w-full bg-blue-500 text-white rounded-md px-2 py-2 mt-5 hover:bg-blue-700">Tìm kiếm</button>
            </form>
        </div>
    </div>
</div>