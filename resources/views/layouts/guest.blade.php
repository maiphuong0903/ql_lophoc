...
<body>
    <div class="flex flex-wrap content-center justify-center w-full min-h-screen py-10 bg-blue-50">
        <div class="flex shadow-md">
            ...
            <div class="md:flex md:flex-wrap content-center justify-center rounded-r-md w-[25rem] h-[28rem] xl:w-[30rem] xl:h-[40rem] hidden">
                <img class="w-full h-full bg-center bg-no-repeat bg-cover rounded-r-md" src="{{ asset('images/logo-login.jpg') }}">
            </div>
        </div>
    </div>
</body>
