<div class="hidden w-60 overflow-y-auto bg-white md:block flex-shrink-0 pt-1.5 border h-full" id="menu-mobile">
    <div class="px-4 py-3">
    ...
    <div class="relative">
        ...
        <ul id="menu">
            ...
            <li class="px-4 py-1">
                <a href="{{ route('class.member', $classRoom->id) }}" class="inline-flex items-center w-full text-md text-gray-700 font-semibold transition-colors duration-150 px-2 py-2 hover:bg-gray-100 hover:rounded-xl">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
