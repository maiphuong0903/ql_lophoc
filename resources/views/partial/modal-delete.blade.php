<div id="deleteModal" tabindex="-1" aria-hidden="true" class="fixed z-50 inset-0 overflow-y-auto hidden">
<form method="POST" id="deleteForm" class="w-2/3">
    @csrf
    @method('DELETE')
        <div class="relative p-4 w-full max-w-md h-full md:h-auto mx-auto my-auto">
            ...
            <div class="relative p-4 text-center bg-white rounded-lg shadow sm:p-5">
                ...
                <p class="mb-4 text-gray-500">Bạn có chắc chắn muốn xóa ?</p>
